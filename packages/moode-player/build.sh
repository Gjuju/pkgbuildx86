...
PKG="moode-player_10.3.5-1moode1"
...
MAJOR_BASE_STATIONS=../dist/binary/moode-stations-full_10.0.0.zip
...
# /mnt (mount points)
mkdir -p $PKG_ROOT_DIR/mnt/{NAS,NVME,OSDISK,SATA}
cp -r "$MOODE_DIR/osdisk/Stereo Test/" $PKG_ROOT_DIR/mnt/OSDISK
cp -r "$MOODE_DIR/osdisk/System Sounds/" $PKG_ROOT_DIR/mnt/OSDISK
